				...
				<div class="footer_social">
					<ul>
						<?php if($bornomala_footer_fb_link){ ?>
							<li><a class="f_facebook wow bounceInDown" target="_blank" href="<?php echo esc_url($bornomala_footer_fb_link);?>"><i style="font: inherit;" class="fa fa-facebook"></i></a></li>
						<?php } if($bornomala_footer_tw_link){ ?>
							<li><a class="f_twitter wow bounceInDown" target="_blank" data-wow-delay=".1s" href="<?php echo esc_url($bornomala_footer_tw_link);?>"><i style="font: inherit;" class="fa fa-twitter"></i></a></li>
						<?php } if($bornomala_footer_gplus_link){ ?>
							<li><a class="f_google wow bounceInDown" target="_blank" data-wow-delay=".2s" href="<?php echo esc_url($bornomala_footer_gplus_link);?>"><i style="font: inherit;" class="fa fa-google-plus"></i></a></li>
						<?php } if($bornomala_footer_linkedin_link){ ?>
							<li><a class="f_linkedin wow bounceInDown" target="_blank" data-wow-delay=".3s" href="<?php echo esc_url($bornomala_footer_linkedin_link);?>"><i style="font: inherit;" class="fa fa-linkedin"></i></a></li>
						<?php } if($bornomala_footer_youtube_link){ ?>
							<li><a class="f_youtube wow bounceInDown" target="_blank" data-wow-delay=".4s" href="<?php echo esc_url($bornomala_footer_youtube_link);?>"><i style="font: inherit;" class="fa fa-youtube"></i></a></li>
						<?php } if($bornomala_footer_skype_link){ ?>
							<li><a class="f_skype wow bounceInDown" target="_blank" data-wow-delay=".5s" href="<?php echo esc_url($bornomala_footer_skype_link);?>"><i style="font: inherit;" class="fa fa-skype"></i></a></li>
						<?php } if($bornomala_footer_instagram_link){ ?>
							<li><a class="f_instagram wow bounceInDown" target="_blank" data-wow-delay=".6s" href="<?php echo esc_url($bornomala_footer_instagram_link);?>"><i style="font: inherit;" class="fa fa-instagram"></i></a></li>
						<?php } ?>
					</ul>
				</div>
			</div><!--- END COL -->
